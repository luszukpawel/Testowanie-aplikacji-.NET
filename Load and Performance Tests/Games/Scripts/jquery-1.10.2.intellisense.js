...
intellisense.annotate(jQuery, {
  ...
  'ajaxTranGame': function() {
    ...
    ///   <param name="handler(options, originalOptions, jqXHR)" type="Function">A handler to return the new tranGame object to use with the data type provided in the first argument.</param>
    /// </signature>
  },
  'boxModel': function() {
